...
public class Generate {
    ...
    public List<Long> zeckendorfsRepresentation (long number, List<Long> fibonacciNumbers) {
        ...
        for (int i = fibonacciNumbers.size()-1; i > 0; i--) {
            ...
            long currentFibonacciNumber = fibonacciNumbers.get(i);
    ...
    public void getTheZeckendorfSumForAllNumbers(Long lowerRange, Long upperRange ){
        ...
        List<Long> fibonacciNumbers= findFibonnaciNumbers(0,upperRange);

        for (long i= lowerRange; i<=upperRange;i++){
            List<Long> zeckendorfRepresentation=zeckendorfsRepresentation(i,fibonacciNumbers);
